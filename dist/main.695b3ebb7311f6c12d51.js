        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("".concat(this.baseUrl, "/api/registration"), {
                method: "POST",
                headers: {
...
var Form = /*#__PURE__*/function () {
   ...
   */
  function Form(formSelector, messagePopup) {
    var _this = this;
    ...
    this.fields.forEach(function (field) {
      return field.addEventListener("input", _this.resetFieldErrors.bind(_this, field));
    });
    this.form.addEventListener("submit", this.submitForm.bind(this));
  }
  _createClass(Form, [{
    key: "resetFieldErrors",
    value: function resetFieldErrors(field) {
    ...
    key: "isEmailValid",
    value: function isEmailValid(emailField) {
      var parentNode = emailField.closest("".concat(this.formSelector, "-field-wrap"));
      parentNode.classList.remove("invalid-email");
      if (!(0,_helpers__WEBPACK_IMPORTED_MODULE_0__.isEmailValid)(emailField.value)) {
...
var isEmailValid = function isEmailValid(email) {
  var emailRegExp = /^(((?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uD800-\uDFFF\uFEFF])[\s\S]|[\uD800-\uDBFF][\uDC00-\uDFFF])+(\.(?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uD800-\uDFFF\uFEFF])[\s\S]|[\uD800-\uDBFF][\uDC00-\uDFFF])+)*)|("(?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])+"))@(((?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uD800-\uDFFF\uFEFF])[\s\S]|[\uD800-\uDBFF][\uDC00-\uDFFF])+\.)+(?:(?![\t-\r "\(\),\.:-<>@\[\]\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uD800-\uDFFF\uFEFF])[\s\S]|[\uD800-\uDBFF][\uDC00-\uDFFF]){2,})$/i;
...
var mask = function mask(elementId) {
  var element = document.getElementById(elementId);
  var maskOptions = {
    mask: "+{375} (00) 000-00-00"
  };
  (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(element, maskOptions);
};
...
var Popup = /*#__PURE__*/function () {
  ...
  _createClass(Popup, [{
    ...
    key: "setMessage",
    value: function setMessage(title, message) {
...
/* harmony import */ var _js_mask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/mask.js */ "./src/js/mask.js");
/* harmony import */ var _js_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/form */ "./src/js/form.js");
/* harmony import */ var _js_popup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/popup */ "./src/js/popup.js");
